...
//Keep score (Needs more work)
if (isStorage && localStorage.getItem('correctCount')) {
	elements.scores = localStorage.getItem('correctCount').split(',');
}
isStorage && localStorage.setItem('correctCount', elements.scores);
...
// clear button (neeed more work)
function clear() {
	document.getElementById("correctCount").reset();
	document.getElementById("incorrectCount").reset();
	document.getElementById("unanswerCount").reset();
  }
  console.log(clear)